        ...
        if (selection == 1) {
            ...
            if (innerSelection == 1) {
                ...
                for (const Entities::Entry& entry : allEntries) {
                    std::cout << entryIndex << " - " << entry.entryName.getString() << " : " << entry.login.getString() << std::endl;
            ...
            if (entrySelection > entryIndex+1 || entrySelection < 1) {
                ...
                if (actionSelection == 1) {
                    std::cout << InstanceManager::passwordDecryptor->decrypt(selectedEntry.encryptedPassword).getString() << std::endl;
                }
                    ...
                    if (fieldSelection == 1) {
                        ...
                        InstanceManager::entryRepository->modifyEntry(selectedEntry, ValueObjects::EntryName(newEntryNameString));
                    }
                    else if (fieldSelection == 2) {
                        std::cout << "Enter new login: ";
                        std::string newLoginString;
                        std::cin >> newLoginString;
                        InstanceManager::entryRepository->modifyEntry(selectedEntry, ValueObjects::Login(newLoginString));
                    }
